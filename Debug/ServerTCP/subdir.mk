...
C_SRCS += \
../ServerTCP/server_tcp.c 

OBJS += \
./ServerTCP/server_tcp.o 

C_DEPS += \
./ServerTCP/server_tcp.d 


# Each subdirectory must supply rules for building sources it contributes
ServerTCP/%.o: ../ServerTCP/%.c ServerTCP/subdir.mk
...
clean: clean-ServerTCP

clean-ServerTCP:
	-$(RM) ./ServerTCP/server_tcp.d ./ServerTCP/server_tcp.o

.PHONY: clean-ServerTCP
